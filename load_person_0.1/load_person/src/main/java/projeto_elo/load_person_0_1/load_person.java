...
package projeto_elo.load_person_0_1;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_1";
		...
		int tos_count_tDBConnection_1 = 0;
            ...
            String url_tDBConnection_1 = "jdbc:postgresql://"+"host"+":"+"5432"+"/"+"postgres";
            
            if(dbProperties_tDBConnection_1 != null && !"".equals(dbProperties_tDBConnection_1.trim())) {
                url_tDBConnection_1 = url_tDBConnection_1 + "?" + dbProperties_tDBConnection_1;
            }
	String dbUser_tDBConnection_1 = "postgres_user";
	
	
		 
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Qqdis9yEU1Jl93CQvic9qpENVNQI9Sl6oG1XJ2PbeQvoO3rW1cFf6GXL3w==");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:BioL2NBlg5zSjnttE/bbNYb9397OP7Feh6pp36lxSDMwzaGjHoDwxT+GPw==");
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_PROJETO_ELO_load_person = new byte[0];
    static byte[] commonByteArray_PROJETO_ELO_load_person = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJETO_ELO_load_person.length) {
				if(length < 1024 && commonByteArray_PROJETO_ELO_load_person.length == 0) {
   					commonByteArray_PROJETO_ELO_load_person = new byte[1024];
				} else {
   					commonByteArray_PROJETO_ELO_load_person = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJETO_ELO_load_person, 0, length);
			strReturn = new String(commonByteArray_PROJETO_ELO_load_person, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJETO_ELO_load_person) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = load_person.class.getClassLoader().getResourceAsStream("projeto_elo/load_person_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     170331 characters generated by Talend Open Studio for Big Data 
 *     on the 1 de Junho de 2023 16h21min3s BRT
 ************************************************************************************************/