...
package tcc.stage_1_person_0_1;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_5";
		...
		int tos_count_tDBConnection_5 = 0;
            ...
            String url_tDBConnection_5 = "jdbc:postgresql://"+"commercial-reports-db.qa.naturacloud.com"+":"+"5432"+"/"+"odsdw";
	...
	String dbUser_tDBConnection_5 = "odsdw_user";
	
	
		 
	final String decryptedPassword_tDBConnection_5 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:SC0X/PMjn4JkX4T3iE4n2jksw1SAcmWpd3b6t1GCyJ0XmE+AyaBj/wpXcA==");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:4WjejADRnmecXc+9ux/qi9keJHREClaWP4780G3oVWHxO6TV8QpcMg==");
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_TCC_stage_1_person = new byte[0];
    static byte[] commonByteArray_TCC_stage_1_person = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TCC_stage_1_person.length) {
				if(length < 1024 && commonByteArray_TCC_stage_1_person.length == 0) {
   					commonByteArray_TCC_stage_1_person = new byte[1024];
				} else {
   					commonByteArray_TCC_stage_1_person = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TCC_stage_1_person, 0, length);
			strReturn = new String(commonByteArray_TCC_stage_1_person, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TCC_stage_1_person) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = stage_1_person.class.getClassLoader().getResourceAsStream("tcc/stage_1_person_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     116358 characters generated by Talend Open Studio for Big Data 
 *     on the 31 de Maio de 2023 18h8min51s BRT
 ************************************************************************************************/