...
package projeto_elo.stage_2_person_0_1;
...
/**
 * Job: stage_2_person Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class stage_2_person implements TalendJob {
...
public Integer getCountry(){
	...
	private final String jobName = "stage_2_person";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_a_XJUP_vEe2OObQVVjZ8wg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				stage_2_person.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(stage_2_person.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
System.out.println("Final do processamento Carga da stage 2 as: " + TalendDate.getCurrentDate());
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_1";
		...
		int tos_count_tDBConnection_1 = 0;
            ...
            String url_tDBConnection_1 = "jdbc:postgresql://"+"host"+":"+"5432"+"/"+"db";
            
            if(dbProperties_tDBConnection_1 != null && !"".equals(dbProperties_tDBConnection_1.trim())) {
                url_tDBConnection_1 = url_tDBConnection_1 + "?" + dbProperties_tDBConnection_1;
            }
	String dbUser_tDBConnection_1 = "user";
	
	
		 
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:vIvMLz3haG98ukIGzqmGe6I7u//4fZneYJbOsTJ4bHH2U4Wxj7EksLNA0A==");
...
System.out.println("Inicio do processamento Carga da stage 2 as: " + TalendDate.getCurrentDate());
...
public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
    final static byte[] commonByteArrayLock_PROJETO_ELO_stage_2_person = new byte[0];
    static byte[] commonByteArray_PROJETO_ELO_stage_2_person = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJETO_ELO_stage_2_person.length) {
				if(length < 1024 && commonByteArray_PROJETO_ELO_stage_2_person.length == 0) {
   					commonByteArray_PROJETO_ELO_stage_2_person = new byte[1024];
				} else {
   					commonByteArray_PROJETO_ELO_stage_2_person = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJETO_ELO_stage_2_person, 0, length);
			strReturn = new String(commonByteArray_PROJETO_ELO_stage_2_person, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJETO_ELO_stage_2_person) {
...
public static class stage_2Struct implements routines.system.IPersistableRow<stage_2Struct> {
    final static byte[] commonByteArrayLock_PROJETO_ELO_stage_2_person = new byte[0];
    static byte[] commonByteArray_PROJETO_ELO_stage_2_person = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final stage_2Struct other = (stage_2Struct) obj;
	...
	public void copyDataTo(stage_2Struct other) {
	...
	public void copyKeysDataTo(stage_2Struct other) {
     ...
     * Compare keys
     */
    public int compareTo(stage_2Struct other) {
...
stage_2Struct stage_2 = new stage_2Struct();
 ...
 */
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"stage_2");
					}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("stage_2_person");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("stage_2_person");
}
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"brm_person_uid\",\"company\",\"country\",\"person_code\",\"person_uid\",\"person_name\",\"created_by\",\"created_at\",\"user_name\",\"last_change_date\") VALUES (?,?,?,?,?,?,?,?,?,?)";
...
stage_2Struct stage_2_tmp = new stage_2Struct();
// ###############################
...
+", \n  created_at, \n  user_name, \n  last_change_date\nFROM public.stage_1_person\n";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row17.brm_person_uid = null;
							} else {
	                         		
        	row17.brm_person_uid = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row17.company = null;
							} else {
		                          
            row17.company = rs_tDBInput_1.getInt(2);
            ...
            row17.country = rs_tDBInput_1.getInt(3);
            if(rs_tDBInput_1.wasNull()){
                    row17.country = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row17.person_code = null;
							} else {
		                          
            row17.person_code = rs_tDBInput_1.getInt(4);
            if(rs_tDBInput_1.wasNull()){
                    row17.person_code = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row17.person_uid = null;
							} else {
	                         		
        	row17.person_uid = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row17.person_name = null;
							} else {
	                         		
        	row17.person_name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row17.created_by = null;
							} else {
	                         		
        	row17.created_by = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row17.created_at = null;
							} else {
										
			row17.created_at = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 8);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row17.user_name = null;
							} else {
	                         		
        	row17.user_name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row17.last_change_date = null;
							} else {
										
			row17.last_change_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 10);
		                    }
...
// # Output table : 'stage_2'
stage_2_tmp.brm_person_uid = java.util.UUID.randomUUID().toString() ;
stage_2_tmp.company = row17.company ;
stage_2_tmp.country = row17.country ;
stage_2_tmp.person_code = row17.person_code ;
stage_2_tmp.person_uid = java.util.UUID.randomUUID().toString() ;
stage_2_tmp.person_name = row17.person_name ;
stage_2_tmp.created_by = "migra_tcc";
stage_2_tmp.created_at = row17.created_at ;
stage_2_tmp.user_name = row17.user_name ;
stage_2_tmp.last_change_date = row17.last_change_date ;
stage_2 = stage_2_tmp;
// ###############################
...
if(stage_2 != null) { 
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"stage_2");
					}
        ...
        whetherReject_tDBOutput_1 = false;
                    if(stage_2.brm_person_uid == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, stage_2.brm_person_uid);
}

                    if(stage_2.company == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(2, stage_2.company);
}

                    if(stage_2.country == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(3, stage_2.country);
}

                    if(stage_2.person_code == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(4, stage_2.person_code);
}

                    if(stage_2.person_uid == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, stage_2.person_uid);
}

                    if(stage_2.person_name == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, stage_2.person_name);
}

                    if(stage_2.created_by == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, stage_2.created_by);
}

                    if(stage_2.created_at != null) {
pstmt_tDBOutput_1.setTimestamp(8, new java.sql.Timestamp(stage_2.created_at.getTime()));
} else {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.TIMESTAMP);
}

                    if(stage_2.user_name == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, stage_2.user_name);
}

                    if(stage_2.last_change_date != null) {
pstmt_tDBOutput_1.setTimestamp(10, new java.sql.Timestamp(stage_2.last_change_date.getTime()));
} else {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.TIMESTAMP);
            ...
            if(!whetherReject_tDBOutput_1) {
                            row8 = new row8Struct();
                                row8.brm_person_uid = stage_2.brm_person_uid;
                                row8.company = stage_2.company;
                                row8.country = stage_2.country;
                                row8.person_code = stage_2.person_code;
                                row8.person_uid = stage_2.person_uid;
                                row8.person_name = stage_2.person_name;
                                row8.created_by = stage_2.created_by;
                                row8.created_at = stage_2.created_at;
                                row8.user_name = stage_2.user_name;
                                row8.last_change_date = stage_2.last_change_date;
            }
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"stage_2");
			  	}
 ...
 */
	...
	tFlowMeterCatcher_1.addMessage("row8", new Integer(count_tFlowMeter_4), "null", "", "tFlowMeter_4");
...
///////////////////////		
	    		...
	    		if(row7.thresholds != null) { //              
                 row_tLogRow_1[14]=    						    
				                String.valueOf(row7.thresholds)			
					          ;	
 ...
 */
    ...
    public static void main(String[] args){
        final stage_2_person stage_2_personClass = new stage_2_person();

        int exitCode = stage_2_personClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = stage_2_person.class.getClassLoader().getResourceAsStream("projeto_elo/stage_2_person_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = stage_2_person.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : stage_2_person");
        }
...
/************************************************************************************************
 *     134440 characters generated by Talend Open Studio for Big Data 
 *     on the 1 de Junho de 2023 14h44min49s BRT
 ************************************************************************************************/