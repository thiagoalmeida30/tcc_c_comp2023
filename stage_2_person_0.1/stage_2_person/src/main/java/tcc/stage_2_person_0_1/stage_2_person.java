...
package tcc.stage_2_person_0_1;
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:kKmXGIj8qHza74A08fO9DBMJChcid7IfCMDMLR9xbwfWD57aKf2Yy7E4Ig==");
...
public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
    final static byte[] commonByteArrayLock_TCC_stage_2_person = new byte[0];
    static byte[] commonByteArray_TCC_stage_2_person = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TCC_stage_2_person.length) {
				if(length < 1024 && commonByteArray_TCC_stage_2_person.length == 0) {
   					commonByteArray_TCC_stage_2_person = new byte[1024];
				} else {
   					commonByteArray_TCC_stage_2_person = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TCC_stage_2_person, 0, length);
			strReturn = new String(commonByteArray_TCC_stage_2_person, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TCC_stage_2_person) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = stage_2_person.class.getClassLoader().getResourceAsStream("tcc/stage_2_person_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     134173 characters generated by Talend Open Studio for Big Data 
 *     on the 31 de Maio de 2023 18h9min10s BRT
 ************************************************************************************************/